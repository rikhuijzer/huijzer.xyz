...
function plot_data(df::DataFrame)
	...
	for (ax, feat) in zip(axs, features)
		...
		t = "cor($(feat), Y) = $c"
		text!(ax, t; position=(0.02, 0.76), space=:relative)
	end
...
manifest_format = "2.0"
project_hash = "20b9be8206c152a4b5a35096a3a11adb3c472328"
...
git-tree-sha1 = "b7643a265011802992d29707841064b5120f2403"
...
[[deps.LightGBM]]
deps = ["Dates", "Libdl", "LightGBM_jll", "MLJModelInterface", "SparseArrays", "Statistics"]
git-tree-sha1 = "868260943bfb2e13e129216b88b8b70014c044e4"
uuid = "7acf609c-83a4-11e9-1ffb-b912bcd3b04a"
version = "1.0.0"

[[deps.LightGBM_jll]]
deps = ["Artifacts", "CompilerSupportLibraries_jll", "JLLWrappers", "LLVMOpenMP_jll", "Libdl"]
git-tree-sha1 = "20ee4be44c3149606abde993dc72dd2cf9909adb"
uuid = "0e4427ef-1ff7-5cd7-8faa-8ff0877bb2ec"
version = "3.3.5+1"
...
[[deps.Shapley]]
deps = ["ComputationalResources", "Distributions", "Lasso", "LinearAlgebra", "Random", "Statistics", "Tables", "ThreadsX"]
git-tree-sha1 = "b845f6089ca795549ce9ad4deb7219d2ca43e4c7"
uuid = "855ca7ad-a6ef-4de2-9ca8-726fe2a39065"
version = "0.1.2"
