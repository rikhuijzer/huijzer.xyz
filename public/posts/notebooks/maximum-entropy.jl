...
# ╔═╡ 1946d48c-88fe-453a-b3fe-f278f0d5ad6d
begin
	using CairoMakie
	using DataFrames
end

# ╔═╡ ab4f6950-4950-11ec-0536-c7c7dd1b6791
md"""
...
This principle is clearly explained by Jaynes ([1968](https://doi.org/10.1109/TSSC.1968.300117)): consider a die which has been tossed a very large number of times $N$. We expect the average to be 3.5, that is, we expect a distribution where $P_n = \frac{1}{6}$ for each $n$, see the figure below.
"""

# ╔═╡ 2880a4d3-333f-4527-9304-115f693b564b
...
# ╔═╡ a29e4a15-43a7-400b-a698-c95bce5a30ac
plot_distribution([1/6, 1/6, 1/6, 1/6, 1/6, 1/6])

# ╔═╡ 3b4894eb-e9cf-4e6a-b233-a4c253cc174e
md"""
...
# ╔═╡ 1a72fe58-9f89-4812-8d96-189a7f93c4a9
plot_distribution([0, 0, 0, 0.5, 0.5, 0])

# ╔═╡ 0fddf512-ef60-43a0-a9c5-6b3f2cadbe14
md"""
...
# ╔═╡ 902ea92c-a4bc-4d17-b0c4-5b28672b0fb6
plot_distribution([0, 0, 1/4, 1/4, 1/4, 1/4])

# ╔═╡ 70db37c1-be45-492d-9faa-d54f51975cbf
md"""
...
# ╔═╡ 2d6355d3-6eaa-4d00-a992-7c9b358fed2f
plot_distribution([(12n - 7)/210 for n in 1:6])

# ╔═╡ fb1e4909-9e59-4c27-b9b4-ef1f248c1c22
md"""
...
# ╔═╡ 90caddba-50ae-4eaa-a47c-48686c38d246
md"""
...
# ╔═╡ 0fda1711-5cdf-4cbf-a342-f4d7061332e9
plot_distribution([0.0543, 0.0787, 0.114, 0.165, 0.240, 0.348])

# ╔═╡ f776e4f9-e346-4b48-8321-701a0c3628b8
md"""
...
# ╔═╡ 6e52f5dc-f54e-4ab2-a3e0-df64939bc1e2
md"""
### Trial and error
"""

# ╔═╡ 66b59195-65c5-45d5-a52c-86c141112356
p(k, rho) = exp(rho*k) / sum([exp(rho*1), exp(rho*2), exp(rho*3), exp(rho*4), exp(rho*5), exp(rho*6)])

# ╔═╡ b65542b2-d491-424e-8a92-2c611af05e72
function ps(rho)
...
# ╔═╡ 6c4a7a20-a022-4a57-a2a6-49ebcec9f4b7
ps(0.4)

# ╔═╡ c39ca772-ae63-4d94-8a3e-ad33c95c7e99
ps(0.34)

# ╔═╡ b8c3c91d-e600-43e8-83b8-d88a94df95af
ps(0.3715)
...
manifest_format = "2.0"
project_hash = "dbf4bd742f0dff80ca55556b91dcc63b6b857e87"
