...
# ╔═╡ e38b4792-1511-4819-aaea-81b2743d936c
begin
...
# ╔═╡ 4ce43b24-4a23-11ec-361b-97b002e29b15
md"""
...
# ╔═╡ 6d89e6fa-7649-43e3-ac3a-fc2138368e4e
md"""
## Covariance
...
# ╔═╡ 81456021-979e-47fa-a445-cb8fb71db8bf
md"""
### Example 1
...
# ╔═╡ 80c59566-227f-4081-a268-f4e36c97aec6
df = let
	X = collect(1:7)
	A = [x + 1 for x in X]
	B = [0.5x + 3 for x in X]
...
# ╔═╡ a96a16f3-78ed-41af-b891-54ede567b671
md"""
and plot the variables to obtain the following figure:
"""

# ╔═╡ 47cccb0f-29e8-4368-a155-f178b469fcbe
# hideall
let
...
# ╔═╡ f2be17e8-79d7-46e8-b7c5-12ed7717d67c
md"""
...
# ╔═╡ b086dd3a-5a2f-47c8-8c7f-7e6b58adf620
md"""
...
# ╔═╡ 884d512e-8c6d-44f1-abbd-3b841ff2c052
md"""
## Conclusion
...
# ╔═╡ 8f80cb65-ce2a-49ac-9450-4aa7e58e4b78
md"""
## References
...
# ╔═╡ 66d6d288-de1c-4524-b9b6-56990dd3531b
md"""
## Appendix 1
"""

# ╔═╡ cf8e8b30-3b13-47da-b6ad-e21146e4afde
function mycov(X, Y)
...
# ╔═╡ 5d30960f-fd3b-45d4-8a69-805501556217
mycov(df.A, df.A)

# ╔═╡ 42275f7e-085c-4437-b341-d991b7d93be3
mycov(df.A, df.B)

# ╔═╡ 241eea51-cafc-4914-8504-f0aede51fc03
mycov(df.A, df.C)

# ╔═╡ bfa93d48-44ed-4ba2-b998-534c7072f4a1
mycov(df.A, df.D)
...
manifest_format = "2.0"
project_hash = "ddef43051bc7fb1c84ccf53a949f03deb1d5a785"
