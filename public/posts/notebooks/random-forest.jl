...
# ╔═╡ d81e1ba0-3764-11ec-31e0-39e0a809eb22
begin
...
# ╔═╡ fc4a1a9e-3c55-4bec-a25f-b96234e04fe8
md"""
...
# ╔═╡ 7d4f039a-ba74-4297-ae2b-3a15b6500a9c
md"""
## Data generation
...
# ╔═╡ a13b43cf-c8e9-48d0-9e8b-aad9260fe73d
classlabels = ["A", "B"];

# ╔═╡ 63d28c3a-9a36-4bec-8316-c673eb32cf2c
df = let
...
# ╔═╡ fd5d1da4-99a4-41d3-b9de-de62a61f79d9
X = (; df.U, df.V);

# ╔═╡ a2c97075-3e74-46e0-96cb-b64de2fea82b
y = df.class;

# ╔═╡ f526ef15-2e2f-43dc-9b03-0611f40eed74
md"""
...
# ╔═╡ e922bf96-e534-4456-b0a7-e8b8d0eb7103
let
	fig = Figure()
...
# ╔═╡ ab2c4267-ad15-4432-935b-8710114973cf
# hideall
md"""
...
# ╔═╡ 7779bfa3-6831-4ac0-b1e9-1762c91a7fae
train, test = let
	rng = StableRNG(123)
...
# ╔═╡ 313540b5-d172-441e-b125-34d32aa23b98
r2(x) = round(x; digits=2);

# ╔═╡ b9d22617-f521-44d8-9b14-98029c92419e
...
# ╔═╡ d7f0507f-f3be-4517-a5a8-93c116ac0693
md"""
...
# ╔═╡ 2bdf65a8-dc46-4435-9bec-d847bd4dae05
begin
	struct RocCurve
		fprs::Vector{Float64}
		tprs::Vector{Float64}
...
# ╔═╡ c52d3f9f-4558-4142-b4a8-2d9c4a6a82e5
md"""
...
However, it could be that the conclusion would be different if the train test split was slightly different.
To draw more robust conclusions, we need cross-validation.
"""

# ╔═╡ 5831290d-81f9-4213-9e7e-f60e0e92dc4d
# hideall
md"""
...
# ╔═╡ 37eb576c-e825-4d86-9d58-bfa7e15bf34e
...
# ╔═╡ 2707e5a5-bcbf-4191-aad9-8bac44c7a88d
evaluate_model(logistic)

# ╔═╡ 1b96c603-f960-4d07-81ac-46e3e1adb4f0
evaluate_model(forest)

# ╔═╡ 11bceb56-f8d6-48b9-a06b-a2525eae991a
md"""
...
# ╔═╡ 195648dc-745d-46e4-853c-d77dd1dd6204
md"""
...
# ╔═╡ 7dca8dfb-6415-4e6d-b331-a033ee09a0c1
...
# ╔═╡ 3349f216-5ba1-4b6e-a672-33abc75d7fe9
md"""
...
# ╔═╡ 5890bb2b-7e05-4c89-a544-74f2734c2937
md"""
...
# ╔═╡ 8782be73-a54a-4a84-af8b-3dd9701dc928
...
# ╔═╡ 0aa466b3-7ee5-4eab-be62-de08e662f57f
md"""
Noice!
There are large differences between the models which makes sense.
This is the nice thing about cross-validation.
It can give an idea of the unstability of the models.
In other words, it's easy to take a single fit as a source of truth while in fact things are much more uncertain.
If you want to see more stable outcomes, download this notebook and increase `n` to get more data.
"""

# ╔═╡ b542d5f4-91a0-4010-9d97-7c6d840523c0
 # hideall
 md"""
 ## Appendix
 """

# ╔═╡ 74a38e38-93f5-4b3e-bdd3-acc68e389a3f
...
# ╔═╡ 9df3c829-8037-4c7c-b199-e9893147b7bf
# ╠═╡ show_logs = false
curves = [
...
# ╔═╡ 991c5caa-fe14-4eee-9865-27b4e981b016
# ╠═╡ show_logs = false
cv_curves = [
...
# ╔═╡ f01f23c2-ae05-49cb-a3aa-513b9f2cffee
...
# ╔═╡ cc8b5145-5c2a-449e-bb6f-949ce47282fa
plot_curves(curves)

# ╔═╡ f2635ef6-300a-4cc8-90fd-4c7d5ced67db
let 
...
manifest_format = "2.0"
project_hash = "2a2f819b736739cd01452fc69b0dfd5c7e13f88e"
...
git-tree-sha1 = "042445dce619c00b250bfef53aafe77321ae91d6"
